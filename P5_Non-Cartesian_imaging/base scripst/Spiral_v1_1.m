...
fov=96*4e-3; Nx=96; Ny=Nx;  % Define FOV and resolution
...
deltak=1/fov*Nr;
kRadius = round(Nx/2/Nr); % the radius of the spiral in k-space, determined by the user-defiled resolution; it is also the number of windings of the spiral.
