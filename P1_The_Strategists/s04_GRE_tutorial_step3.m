...
gamma = 8.7346e6; %39K
% set system limits
% change gamma, B0 and rfIngdowntime
...
for i=1:Ny
    ...
    [rf, gz] = mr.makeSincPulse(alpha*pi/180, 'Duration', 4e-3,...
                                ...
                                'timeBwProduct', 4, ...
                                'system', sys, ...
                                'phaseOffset', rand_phase, ... %%add phase spoiling to rf
                                'use', 'excitation');
    seq.addBlock(rf, gz);
...
seq.write_v141(['DEMO_gre3.seq'])       % Write to pulseq file
